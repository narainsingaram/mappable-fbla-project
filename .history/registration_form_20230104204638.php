...
<div id="contacts" role="tabpanel" aria-labelledby="contacts-tab">
    ...
    <div class="button">
        <button class="btn normal-case w-full border-none px-8 py-4 font-medium text-blue-500 rounded-2xl bg-blue-100 hover:bg-blue-2000" type="submit" name="register_btn">Create Account
        </button>
    </div>
</div>
</div>
