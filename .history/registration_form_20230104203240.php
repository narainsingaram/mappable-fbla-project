...
<div class="mb-4">
    <ul class="flex mb-2 text-sm font-medium text-center" id="myTab" data-tabs-toggle="#myTabContent" role="tablist">
        <li class="mr-2" role="presentation">
            <button style="border: 1px red solid;" class="btn rounded-xl my-2 py-1 px-4 text-sm text-black bg-slate-100 hover:bg-slate-200 border-none normal-case" id="profile-tab" data-tabs-target="#profile" role="tab" aria-controls="profile">  Full Name</button>
        </li>
        <li class="mr-2" role="presentation">
