...
<div class="mb-4">
    <ul class="flex mb-2 text-sm font-medium text-center" id="myTab" data-tabs-toggle="#myTabContent" role="tablist">
        ...
        <li class="mr-2" role="presentation">
            <button class="btn rounded-xl my-2 py-1 px-4 text-sm text-black bg-slate-100 hover:bg-slate-200 border-none normal-case" id="settings-tab" data-tabs-target="#settings" role="tab" aria-controls="settings" aria-selected="false"><Credentials</button>
        </li>
        <li role="presentation">
            <button class="btn rounded-xl my-2 py-1 px-4 text-sm text-black bg-slate-100 hover:bg-slate-200 border-none normal-case" id="contacts-tab" data-tabs-target="#contacts" role="tab" aria-controls="contacts" aria-selected="false">Submit</button>
        </li>
    </ul>
</div>
