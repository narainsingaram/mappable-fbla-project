...
<div id="contacts" role="tabpanel" aria-labelledby="contacts-tab">
    ...
    <div class="button">
        <button class="btn w-full px-8 py-4 font-medium text-white transition duration-500 ease-in-out transform bg-blue-500 rounded-2xl hover:bg-blue-600" type="submit" name="register_btn">Create Account
        </button>
    </div>
</div>
</div>
