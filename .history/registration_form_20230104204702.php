...
<div id="contacts" role="tabpanel" aria-labelledby="contacts-tab">
    ...
    <div class="button">
        <button class="btn normal-case w-full border-none px-8 py-4 font-medium text-blue-100 rounded-2xl bg-blue-500 hover:bg-blue-600" type="submit" name="register_btn">Create Account
        </button>
    </div>
</div>
</div>
