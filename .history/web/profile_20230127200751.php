            ...
            <div class="px-6">
              <div class="flex flex-wrap justify-center">
                ...
                <div class='-mt-24 shadow-[rgba(7,_65,_50,_0.1)_0px_9px_100px] inline-flex overflow-hidden relative justify-center items-center w-48 h-48 text-8xl bg-slate-200 rounded-full'>
                    <div class='relative z-10 font-semibold text-gray-600' style='position: relative;'><?php echo $profile_list['first_name'][0] . $profile_list['last_name'][0]; ?>
                  </div>
                  <div class='absolute right-0 bottom-0 z-50	' style='position: absolute;'>
