...
if(isset($_POST['getting_points'])){
    ...
    $points_query = mysqli_query($con,"UPDATE users SET points = '$points', gems = '$gems', experience = '$experience * 1.1', levels = '$lvl_growth', percentage_growth = '$experience * 1.1 - ($lvl_growth) * 100)' WHERE id = '$id'");
    header("Location: index.php");
  }
