              ...
              <div class="flex flex-wrap justify-center">
                <div class="w-full lg:w-6/12 px-4 lg:order-1 flex justify-center">
                  <div class='-mt-24 shadow-[rgba(7,_65,_50,_0.1)_0px_9px_100px] inline-flex overflow-hidden relative justify-center items-center w-48 h-48 text-8xl bg-slate-200 rounded-full'>
                    <span class='font-semibold text-gray-600 mb-4'><?php echo $profile_list['first_name'][0] . $profile_list['last_name'][0]; ?>
                  </span>
                  <div class='fixed z-60'>
                    <sup class='bg-blue-500 text-blue-500 text-xs px-3 py-2 rounded-full'><?php echo $profile_list['position']; ?></sup>
                    </div>
                  </div>
                </div>
