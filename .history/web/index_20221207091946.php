                ...
                <div class='card-body'>
                  ...
                  <div class='card-actions justify-end'>
                    <form name='index.php' method='POST'>
                      <a href='space.php?space=$id' class='btn inline-flex py-2 px-3 font-medium text-center text-green-500 hover:text-green-600 bg-green-200/60 cursor-pointer rounded-xl' type='submit' name='$id-spaces-request'>Go To Space</a>
                    </form>
                </div>
              </div>
            </div>
          ...
          else
            {
              ...
              <div id='spaces_div' class='my-3 card rounded-2xl shadow-[rgba(7,_65,_50,_0.1)_0px_9px_50px] border-none'>
                <div class='card-body'>
                  ...
                  <div class='card-actions justify-end'>
                    <form name='index.php' method='POST'>
                      <button class='inline-flex py-2 px-3 font-medium text-center text-blue-500 bg-blue-200/60 cursor-pointer rounded-xl' type='submit' name='$id-spaces-request'> 
