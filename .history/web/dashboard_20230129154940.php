...
<div class="flex-auto p-6 bg-slate-100 rounded-xl">
...
<div class="relative h-full overflow-hidden bg-cover px-2 py-2 rounded-xl" style="background-image: url('../assets/img/ivancik.jpg')">
<span class="bg-center bg-cover bg-gradient-to-tl from-gray-900 to-slate-800 opacity-80"></span>
<div class="relative z-10 flex flex-col flex-auto h-full p-4">
<h5 class="pt-2 mb-3 text-2xl font-bold text-white">Join the Top of the Leaderboard</h5>
<div class="">
	<li class='text-white'>By participating in a variety of events and activities in Mappable, you can accumulate points and gems, helping you rise to the top of the leaderboard.</li>
	<br>
	<li class='text-white'>Being in the top ranks of the leaderboard gives you the opportunity to buy rewards from the school store, and being in the top 3 for gems or points may lead to being selected for a prize.</li>
</div>
</div>
	</div>
		</div>
