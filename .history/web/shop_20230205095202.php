            ...
            <div class="relative inline-block px-4 pt-5 pb-4 overflow-hidden text-left align-bottom transition-all transform bg-white rounded-lg shadow-xl rtl:text-right dark:bg-gray-900 sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6">
                <div>
                    ...
                    <div class="mt-2 text-center">
                        <h3 class="text-lg font-medium leading-6 text-gray-800 capitalize dark:text-white" id="modal-title">Points Reward</h3>
                        <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">
                          Congratulations, you are first place within your school based on the amount of points you have. So, collect your T-Shirt reward by claiming here.
                        </p>
                    </div>
                </div>
