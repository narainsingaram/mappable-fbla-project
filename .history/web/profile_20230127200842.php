              ...
              <div class="flex flex-wrap justify-center">
                <div class="w-full lg:w-6/12 px-4 lg:order-1 flex justify-center">
                  <div class='-mt-24 shadow-[rgba(7,_65,_50,_0.1)_0px_9px_100px] inline-flex overflow-hidden relative justify-center items-center w-48 h-48 text-8xl bg-slate-200 rounded-full'>
                    <div class='relative z-10 font-semibold text-gray-600'><?php echo $profile_list['first_name'][0] . $profile_list['last_name'][0]; ?>
                  </div>
                    <sup class='absolute bottom-0 bg-blue-500 text-blue-100 text-xs px-3 py-2 rounded-full h-8'><?php echo $profile_list['position']; ?></sup>
                  </div>
                </div>
