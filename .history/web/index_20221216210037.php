...
if(isset($_POST['getting_points'])){
    ...
    $points_query = mysqli_query($con,"UPDATE users SET points = '$points', gems = '$gems', experience = '$lvl_growth', levels = '$floor_lvl', percentage_growth = '$lvl_growth - ($floor_lvl))' WHERE id = '$id'");
    header("Location: index.php");
  }
