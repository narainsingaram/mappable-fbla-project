...
<div class="">
	<ul class='list-none'>
	<li class='text-black bg-slate-200 px-4 py-3'>By participating in a variety of events and activities in Mappable, you can accumulate points and gems, helping you rise to the top of the leaderboard.</li>
	<br>
	<li class='text-black bg-slate-200 px-4 py-3'>Being in the top ranks of the leaderboard gives you the opportunity to buy rewards from the school store, and being in the top 3 for gems or points may lead to being selected for a prize.</li>
</ul>
</div>
</div>
	</div>
