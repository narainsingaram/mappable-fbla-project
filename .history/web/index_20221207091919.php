                ...
                <div class='card-body'>
                  ...
                  <div class='card-actions justify-end'>
                    <form name='index.php' method='POST'>
                      <a href='space.php?space=$id' class='inline-flex py-2 px-3 font-medium text-center text-green-500 hover:text-green-600 bg-green-200 cursor-pointer rounded-xl' type='submit' name='$id-spaces-request'>Go To Space</a>
                    </form>
                </div>
              </div>
            </div>
