...
if(isset($_POST['getting_points'])){
    ...
    $points_query = mysqli_query($con,"UPDATE users SET points = '$points', gems = '$gems', experience = '$lvl_growth * 1.1', levels = '$floor_lvl', percentage_growth = '$experience * 1.1 - ($floor_lvl) * 100)' WHERE id = '$id'");
    header("Location: index.php");
  }
