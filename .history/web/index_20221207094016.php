                ...
                <div class='card-body'>
                  ...
                  <div class='card-actions justify-end'>
                    <form name='index.php' method='POST'>
                      <a href='space.php?space=$id' class='inline-flex py-2 px-3 font-medium text-center text-blue-500 bg-blue-200/60 cursor-pointer rounded-xl' name='$id-spaces-request'>Go To Space</a>
                    </form>
                </div>
              </div>
            </div>
