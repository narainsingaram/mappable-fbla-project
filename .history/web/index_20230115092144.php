  ...
  <?php 
    if(isset($_POST['getting_points'])){
      ...
      $percentage_growth = $experience_growth - ($levels * 100); 
       $points_query = mysqli_query($connection,"UPDATE users SET points = '$points', gems = '$gems', experience = '$experience_growth', levels = '$levels', percentage_growth = '$percentage_growth' WHERE id = '$id'"); 
      header("Location: index.php");
      }
