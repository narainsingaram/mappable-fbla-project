...
if(isset($_POST['spc_msg_send'])) {
    ...
    $type = $_POST['msg_type'];
    $post->event_feed($space_id,$userLoggedIn, $_POST['spc_msg_input'], $_POST['msg_type'], $date, $_POST['user_desc'], $filename, 'none'); //do submitEvent function in Post_Events.php
