...
include("includes/operators/register_operator.php");
...
if(isset($_POST['reward_submit'])) {
  ...
  $insert_reward_query = mysqli_query($connection, "INSERT INTO claimed_reward VALUES(NULL, $userLoggedin, '{$_POST['reward_value']}', ");
}
