                ...
                <div class='card-body'>
                  ...
                  <button class='card-actions justify-end'>
                    ...
                    <button class='py-2 px-4 bg-green-500 text-white rounded-lg shadow-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-400 focus:ring-opacity-75'> FDASF </BUTTON>
                      ...
                      <button class='btn inline-flex py-2 px-3 font-medium text-center text-blue-500 bg-blue-200/60 cursor-pointer rounded-xl' type='submit' name='$id-spaces-request'> 
