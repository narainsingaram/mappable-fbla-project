...
if(isset($_POST['getting_points'])){
    ...
    $percentage_growth = ($lvl_growth - ($floor_lvl) * 100);
    $points_query = mysqli_query($con,"UPDATE users SET points = '$points', gems = '$gems', experience = '$lvl_growth', levels = '$floor_lvl', percentage_growth = '$percentage_growth' WHERE id = '$id'");
    header("Location: index.php");
  }
