...
if(isset($_POST['spc_msg_send'])) {
    ...
    $type = $_POST['msg_type'];
    $post->event_feed($space_id,$userLoggedIn, $_POST['user_date'], $_POST['user_start'], $_POST['user_end'], $_POST['user_desc'], $filename, 'none'); //do submitEvent function in Post_Events.php
