    ...
    <span class='font-semibold text-gray-600'>$first_name[0]$last_name[0]</span>
            ...
            <form action='index.php' method='POST' enctype='multipart/form-data'>
                ...
                <input type='hidden' name='auth_image' value='$image'>
                    <button name='auth_submit' type='submit' class='bg-emerald-100 text-black hover:bg-emerald-200 border-none rounded-xl capitalize font- m-1 btn bottom-4 right-1 absolute active:scale-105 rounded-full'> 
                        <i class='text-xl mr-2 uil uil-comment-add'></i>
                    </button>
            </form>  
    </main>
    </div>
