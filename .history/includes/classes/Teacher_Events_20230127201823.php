    ...
    <span class='font-semibold text-gray-600'>$first_name[0]$last_name[0]</span>
            ...
            <form action='index.php' method='POST' enctype='multipart/form-data'>
                ...
                <div class='tooltip tooltip-right' data-tip='Request an authentification for {$title}'>
                    <button name='auth_submit' type='submit' class='relative m-auto bg-emerald-100 text-black hover:bg-emerald-200 border-none capitalize mx-2 my-4 btn top-0.5 left-2 bottom-0 rounded-full'> 
