...
EOT;
    ...
    public function display_general_success_noti() {
        $success_alert = <<<EOT
    <div id="toast-success" class="absolute top-0 left-0 right-0 flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow-[rgba(7,_65,_50,_0.1)_0px_9px_50px] z-50" role="alert">
