...
class Notify {
    ...
    public function getNotifications() {
        ...
        switch($row['viewed']) {
            ...
            $return_string .= "
            <li>
                <a class='flex bg-red-200 m-1.5' href='index.php'>
                    <span class='bg-slate-200 p-0.5 w-10 h-10 text-xl font-semibold text-gray-700 rounded-full flex items-center justify-center'>$pfp_name</span>
                    <span>
                        {$row['message']}
                    </span> 
                </a>
