...
if(isset($_POST['auth_submit'])) {
    ...
    public function live_events() {
        ...
        while($live = mysqli_fetch_array($live_event_query)) {
            ...
            $int_current_time = $this->convert_time_to_integer($current_time, $current_time_w_a);
            $int_start_time = $this->convert_time_to_integer($start_time);
            $int_end_time = $this->convert_time_to_integer($end_time);
    
            if ($current_date == $date && $int_current_time > $int_start_time && $int_current_time < $int_end_time) {
                ...
                $live_event_content .= "
                    <div class='p-6 relative rounded-2xl shadow-[rgba(7,_65,_50,_0.1)_0px_9px_50px] hover:-translate-y-1 transition ease-in'>
                        ...
                        <path d='M21.101 9.58786H19.8979V8.41162C19.8979 7.90945 19.4952 7.5 18.999 7.5C18.5038 7.5 18.1 7.90945 18.1 8.41162V9.58786H12.8979V8.41162C12.8979 7.90945 12.4952 7.5 11.999 7.5C11.5038 7.5 11.1 7.90945 11.1 8.41162V9.58786H9.89789C8.83568 9.58786 7.99997 8.74615 7.99997 7.58394V5.58394C7.99997 4.42173 8.83568 3.58002 9.89789 3.58002H11.1V2.41162C11.1 1.90945 11.5038 1.5 12.0001 1.5C12.4953 1.5 12.8979 1.90945 12.8979 2.41162V3.58002H18.1V2.41162C18.1 1.90945 18.5038 1.5 19.0001 1.5C19.4953 1.5 19.8979 1.90945 19.8979 2.41162V3.58002H21.101C22.163 3.58002 23.0001 4.42173 23.0001 5.58394V7.58394C23.0001 8.74615 22.163 9.58786 21.101 9.58786ZM21.101 11.4121C21.101 12.5743 20.163 13.4121 19.101 13.4121H9.89789C8.83568 13.4121 7.99997 12.5743 7.99997 11.4121V7.58394C7.99997 6.42173 8.83568 5.58002 9.89789 5.58002H19.101C20.163 5.58002 21.101 6.42173 21.101 7.58394V11.4121Z' fill='currentColor'></path>
                        </svg>
                        Join Now
                    </a>
                </div>";
                                } else {
                                    $add_live_events = mysqli_query($this->con, "UPDATE teacher_events SET live='no' WHERE event_id='$id' AND added_by='$added_by'");
                                }
                            }
                        }
                        return $live_event_content;
                    }
    ...
    public function attended_events() {
        ...
        while($profile = mysqli_fetch_array($attended_events_query)) {
            ...
            $attended_event_content .= "<div class='relative shadow-[rgba(7,_65,_50,_0.1)_0px_9px_50px] transition ease-in px-3 pb-4 pt-2 rounded-2xl my-4'>
            <div>
                <div>
                    <div class='flex align-center'> 
                    <div class='inline-flex overflow-hidden relative justify-center items-center w-12 h-12 mr-2 text-xl bg-slate-300/30 rounded-full'>
    ...
    public function profile_events() {
        ...
        while($profile = mysqli_fetch_array($profile_event_query)) {
            ...
            $profile_event_content .= "<div class='relative shadow-[rgba(7,_65,_50,_0.1)_0px_9px_50px] transition ease-in px-3 pb-4 pt-2 rounded-2xl my-4'>
            <div>
                <div>
                    <div class='flex align-center'> 
                    <div class='inline-flex overflow-hidden relative justify-center items-center w-12 h-12 mr-2 text-xl bg-slate-300/30 rounded-full'>
