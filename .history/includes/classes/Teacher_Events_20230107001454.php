    ...
    while($event_row = mysqli_fetch_array($event_data_query)) {
        ...
        <div class='flex-1 min-w-0'>
                    ...
                    <form action='index.php' method='POST'>
                        <button name='auth_delete_btn_$id' type='submit' class='inline-flex cursor-pointer active:scale-105 items-center text-xl text-red-400 px-2 py-1 rounded-xl text-gray-900'>
