...
class Notify {
    ...
    public function getNotifications() {
        ...
        if (isset($_POST["{$user_info_query["id"]}-{$user_info_query["username"]}-mark-as-read"])) {
            echo "water";
        }
                    ...
                    <a class='flex bg-slate-100 m-1' href='index.php'>
                        ...
                        <div class="tooltip tooltip-right" data-tip="Mark As Read">
                            <form class="inline" action="index.php">
                                <button type='submit' name='{$user_info_query["id"]}-{$user_info_query["username"]}-mark-as-read' class='bg-emerald-200 badge w-3 text-black border-none'>
