    ...
    <span class='font-semibold text-gray-600'>$first_name[0]$last_name[0]</span>
            ...
            <form action='index.php' method='POST' enctype='multipart/form-data'>
                ...
                <input type='hidden' name='auth_image' value='$image'>
                    <button name='auth_submit' type='submit' class='bg-emerald-100 text-black hover:bg-emerald-200 border-none p-2 capitalize m-1 btn-circle bottom-4 right-1 absolute active:scale-105 rounded-full'> 
