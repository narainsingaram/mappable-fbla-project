...
public function loadAttendanceTable() {
    ...
    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
      <tr class="bg-white hover:bg-gray-50 dark:bg-slate-900 dark:hover:bg-slate-800">
        ...
        <td class="h-px w-px whitespace-nowrap">
          <a class="block h-full p-6" href="#">
            <span class="inline-flex items-center gap-1.5 py-0.5 px-2 rounded-full text-xs font-medium bg-slate-100 text-slate-800 dark:bg-green-900 dark:text-green-200">
