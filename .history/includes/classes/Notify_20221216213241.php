...
class Notify {
    ...
    public function getNotifications() {
        ...
        switch($row['viewed']) {
            ...
            <li>
                <a href='index.php'>
                <span class='bg-slate-200 mask mask-squircle p-2 w-10 h-10 text-xl font-semibold text-gray-700 rounded-full flex items-center justify-center'>$pfp_name</span>
                {$row['message']}</a>
            </li>
            ";
            break;
