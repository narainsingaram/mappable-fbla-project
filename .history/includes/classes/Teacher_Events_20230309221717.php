...
public function loadAuthentifications() {
    ...
    while($auth_rows = mysqli_fetch_array($select_events_query)) {
        ...
        <div class="flex">
            ...
            <div class="mt-4">
                <a href='' type="button" class="inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-medium text-blue-600 hover:underline focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm">
                    Go Back Home
                </a>
                </div>
            </div>
