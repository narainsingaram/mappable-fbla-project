...
public function load_regular_feed() {
    ...
    <span class='font-semibold text-gray-600'>$first_name[0]$last_name[0]</span>
                        ...
                        <ul class='mt-2'>
                            <li>
                                <h3>
                                $first_name $last_name                                  <span class='bg-blue-300/20 text-blue-500 text-xs font-semibold px-2 py-1 tracking-wide rounded'>Lvl. $level $position</span>
                                </h3>
                            </li>
...
<div class='p-6 relative rounded-2xl shadow-[rgba(7,_65,_50,_0.1)_0px_9px_50px] hover:-translate-y-1 transition ease-in'>
    ...
    <a class='inline-flex items-center py-2 px-3 text-sm font-medium text-center text-blue-500 bg-blue-200/60 rounded-xl'>
