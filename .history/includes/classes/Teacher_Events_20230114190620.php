            ...
            <div>
                ...
                <div class='post-images'>
                    ...
                    <div class='p-5 bg-white rounded flex items-center'>
                        ...
                        <p class='bg-slate-300/30 w-1/2 mx-2 rounded-xl px-5 py-4 break-all'><b class=' text-lg'><i class='uil uil-info-circle'></i> Description: </b> <br> <span class='px-2'>$description </span></p>
                    </div>
                </div>
