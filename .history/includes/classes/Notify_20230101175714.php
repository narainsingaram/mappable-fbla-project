        ...
        switch($row['viewed']) {
            ...
            <li>
                    <a class='flex bg-slate-100 m-1' href='index.php'>
                        <span class='indicator bg-slate-200 p-1 w-10 h-10 text-xl font-semibold text-gray-700 rounded-full flex items-center justify-center'>
                        $pfp_name
                        <span class='w-1 h-1 p-0 mr-1 indicator-item badge badge-secondary'></span>
                        </span>
                        <span>
                            {$row['message']}
                        </span> 
