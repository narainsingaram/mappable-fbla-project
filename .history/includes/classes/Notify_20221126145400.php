        ...
        switch($row['viewed']) {
            ...
            <div class='card-body'>
              ...
              <p>You have 3 unread messages. Tap here to see.</p>
                <div class='-bottom-0 -right-0 absolute dropdown dropdown-top dropdown-end'>
            ...
            <span id='notify_unstacked' class='-top-1 -right-1 absolute w-6 h-6 bg-red-400 rounded-full '>
            </span>
          </div> 
            ";
            break;
