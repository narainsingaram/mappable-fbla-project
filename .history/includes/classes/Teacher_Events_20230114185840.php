    ...
    <span class='font-semibold text-gray-600'>$first_name[0]$last_name[0]</span>
            ...
            <form action='index.php' method='POST' enctype='multipart/form-data' class=''>
                ...
                <input type='hidden' name='auth_image' value='$image'>
                    <button name='auth_submit' type='submit' class='btn bottom-2 right-1 absolute active:scale-105 rounded-full text-lg'> 
                        <i class='text-2\xl uil uil-comment-add'></i> Request Authentification
                    </button>
            </form>  
    </main>
    </div>
