...
if(isset($_POST['auth_submit'])) {
    ...
    <div class='-top-0 -right-0 absolute dropdown'>
        <label tabindex='0' class='btn bg-transparent border-none text-black hover:bg-transparent px-3 py-2 active:scale-125 cursor-pointer text-sm'><i class='uil uil-ellipsis-h'></i></label>
