                ...
                <h1 class='rounded-2xl bg-slate-300/30 my-3 px-4 py-3 text-2xl font-bold text-black'>$title</h1>
                    ...
                    <div class='p-4 bg-white rounded flex items-center'>
                        <div class='bg-green-200 h-16 w-16 rounded flex flex-shrink-0 items-center justify-center'>
                            <svg class='fill-current text-green-700 w-6 h-6' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20 20' fill='currentColor'>
                              <path fill-rule='evenodd' d='M3.293 9.707a1 1 0 010-1.414l6-6a1 1 0 011.414 0l6 6a1 1 0 01-1.414 1.414L11 5.414V17a1 1 0 11-2 0V5.414L4.707 9.707a1 1 0 01-1.414 0z' clip-rule='evenodd' />
                            </svg>
                        </div>
                        <div class='flex-grow flex flex-col ml-4'>
                            <span class='text-xl font-bold'>{$reformatted_date}</span>
                            <div class='flex justify-between items-center'>
                                <span class='text-gray-500'>Date</span>
                                <span class='text-sm font-semibold text-green-500 ml-2'>+12.6%</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class='p-4 bg-white rounded flex items-center'>
                        <div class='bg-red-200 h-16 w-16 rounded flex flex-shrink-0 items-center justify-center'>
                            <svg class='fill-current text-red-700 w-6 h-6' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20 20' fill='currentColor'>
                        ...
                        <div class='flex-grow flex flex-col ml-4'>
                            ...
                            <div class='flex justify-between items-center'>
                                <span class='text-gray-500'>Sales last30 days</span>
                                <span class='text-sm font-semibold text-red-500 ml-2'>-8.1%</span>
                            </div>
                        </div>
                    </div>
