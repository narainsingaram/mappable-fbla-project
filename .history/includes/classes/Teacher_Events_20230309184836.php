...
if(isset($_POST['auth_submit'])) {
    ...
    while($event_row = mysqli_fetch_array($event_data_query)) {
        ...
        $last_initial = substr($name_parts[1], -1, 1);
    ...
    <a href='profile.php?profile_username=$username' class='font-semibold text-gray-600'>$added_by_initials[0]$last_name[0]</a>
</div>
                        <ul class='mt-2'>
                            <li>
                                <h3'>
