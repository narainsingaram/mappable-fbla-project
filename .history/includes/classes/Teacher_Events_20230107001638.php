...
public function load_requested_feed() {
    ...
    if(isset($_POST['auth_delete_btn_'])) {
        $create_event_query = mysqli_query($this->con, "SELECT * FROM authentifications WHERE id='$event_row[event_id]' AND requester='$userLoggedIn');
    }
