...
<div class="mb-4">
    <ul class="flex mb-2 text-sm font-medium text-center" id="myTab" data-tabs-toggle="#myTabContent" role="tablist">
        <li class="mr-2" role="presentation">
            <button class="btn bg-slate-100 px-4 py-1 my-2 rounded-xl text-slate-600 text-base" id="profile-tab" data-tabs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="true"> <img class='mb-1 w-7 inline' src='assets/images/user_reg.png'> Full Name</button>
        </li>
        <li class="mr-2" role="presentation">
            <button class="btn border-none bg-slate-100 hover:bg-slate-200 px-4 py-1 my-2 rounded-xl text-slate-600 text-base" id="dashboard-tab" data-tabs-target="#dashboard" type="button" role="tab" aria-controls="dashboard" aria-selected="false"><img class='mb-1 w-7 inline' src='assets/images/user_info.png'> User Info</button>
        </li>
        <li class="mr-2" role="presentation">
