...
<div class="mb-4">
    ...
    <?php 
        $is_selected = ($element['aria-selected'] === true); 
    ?>


        <li class="mr-2" role="presentation">
            <button style="<?php $border_style; ?>" class="btn rounded-xl my-2 py-1 px-4 text-sm text-black bg-slate-100 hover:bg-slate-200 border-none normal-case" id="profile-tab" data-tabs-target="#profile" role="tab" aria-controls="profile" aria-selected="<?php $border_style = ("true") ? 'border: 1px solid black' : "";
?>"
            ">Full Name</button>
        </li>
        <li class="mr-2" role="presentation">
