...
<div id="contacts" role="tabpanel" aria-labelledby="contacts-tab">
    ...
    <div class="button">
        <button class="btn w-full border-none px-8 py-4 font-medium text-blue-400 rounded-2xl bg-blue-100hover:bg-blue-600" type="submit" name="register_btn">Create Account
        </button>
    </div>
</div>
</div>
