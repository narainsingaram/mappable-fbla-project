...
<div class="mb-4">
    <ul class="flex mb-2 text-sm font-medium text-center" id="myTab" data-tabs-toggle="#myTabContent" role="tablist">
        ...
        <li class="mr-2" role="presentation">
            <button class="btn normal-case border-none bg-slate-100 active:bg-slate-200 px-4 py-1 my-2 rounded-xl text-slate-600 text-sm" id="dashboard-tab" data-tabs-target="#dashboard" role="tab" aria-controls="dashboard" aria-selected="false">User Information</button>
        </li>
        <li class="mr-2" role="presentation">
