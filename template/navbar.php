...
<div class="navbar">
  ...
  <div class="dropdown dropdown-end">
    <label tabindex="0" class="btn btn-square btn-ghost m-1 focus:outline-none focus:ring focus:ring-green-300">
    ...
    <ul tabindex="0" class="grid dropdown-content menu p-2 bg-white shadow-[rgba(7,_65,_210,_0.1)_0px_9px_50px] rounded-2xl w-80 overflow-y-auto h-80">
      <div class="px-5 pt-5 pb-2 flex justify-between">
        ...
        <form>
          <button class='mb-2 text-sm text-green-400' type='submit'>Clear All</button>
        </form>
      </div>
    <?php 
    ...
    <div class="dropdown dropdown-end">
      <label tabindex="0" class="btn normal-case border-none inline-flex mx-2 items-center text-sm font-medium text-center text-green-500 bg-green-200/60 cursor-pointer rounded-xl">Create</label>
    ...
    <div class="dropdown dropdown-end ">
      <label tabindex="0" class="btn btn-ghost p-0 hover:bg-green-50">
        <?php echo "<span class='bg-green-200 w-12 h-12 text-xl font-bold text-gray-700  rounded-full flex items-center justify-center'> $profile_symbol </span>";?>
      </label>
        ...
        <div class="card w-96 bg-white">
          <div class="p-4">
            <div class='w-full flex'>
              <p class="w-1/2 inline mx-1 bg-green-200/60 px-4 py-2 rounded-xl shadow-[rgba(7,_65,_210,_0.1)_0px_9px_50px] text-xl "><?php echo $user['gems']; ?> Gems</p>
              <p class="w-1/2 inline mx-1 bg-green-200/60 px-4 py-2 rounded-xl shadow-[rgba(7,_65,_210,_0.1)_0px_9px_50px] text-xl "><?php echo $user['points']; ?> Points</p>
            </div>
          <div class='bg-green-200/60 rounded-xl shadow-[rgba(7,_65,_210,_0.1)_0px_9px_50px] px-2 py-3 mt-4'>
            <div class='pb-1'>
              <span class="text-sm px-2 text-green-600">3</span>
              <span class="text-sm float-right px-2 text-green-600">4</span>
            </div>
            <div class="w-full bg-green-300 rounded-full">
              <div class="bg-green-600 text-xs text-gray-900/60 text-center p-0.5 leading-none rounded-full" style="width: <?php echo $user['percentage_growth']; ?>%"> <?php echo $user['percentage_growth'] . '%'; ?>
              </div>
            </div>
          </div>
