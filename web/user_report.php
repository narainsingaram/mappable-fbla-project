...
//get user list ordeorange by points and gems
...
<div id="content" class='px-4 sm:px-6 lg:px-4'>
	<main>
<header aria-label="Page Header" class="bg-orange-200 mx-8 rounded-xl">
  <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 lg:px-8">
    <div class="my-6">
      <h1 class="font-bold text-orange-900 text-4xl">
        Welcome to Your User Report, <?php echo" <a href='profile.php?profile_username=$userLoggedIn' class='text-orange-600'>$first_name</a>";?>
      </h1>
  ...
  <div class="flex flex-col">
    <div class="-m-1.5 overflow-x-auto">
      <div class="p-1.5 min-w-full inline-block align-middle">
        <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden dark:bg-orange-900 dark:border-gray-700">
          <!-- Header -->
          <div class="px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-b border-gray-200 dark:border-gray-700">
          <h1 class='text-white font-bold text-3xl'>Attedance Report</h1>
                ...
                <div class="hs-dropdown relative inline-block [--placement:bottom-right]">
                  <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden mt-2 divide-y divide-gray-200 min-w-[12rem] z-10 bg-white shadow-md rounded-lg p-2 mt-2 dark:divide-gray-700 dark:bg-gray-800 dark:border dark:border-gray-700" aria-labelledby="hs-as-table-table-export-dropdown">
                    <div class="py-2 first:pt-0 last:pb-0">
                      ...
                      <a class="flex items-center gap-x-3 py-2 px-3 rounded-md text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-orange-500 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300" href="#">
                  ...
                  <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden mt-2 divide-y divide-gray-200 min-w-[12rem] z-10 bg-white shadow-md rounded-lg mt-2" aria-labelledby="hs-as-table-table-filter-dropdown">
                    <div class="divide-y divide-gray-200">
                      <label for="hs-as-filters-dropdown-all" class="flex py-2.5 px-3">
                        <input type="checkbox" class="shrink-0 mt-0.5 border-gray-200 rounded text-orange-600 pointer-events-none focus:ring-orange-500 dark:bg-gray-800 dark:border-gray-700 dark:checked:bg-orange-50 border-orange-200 border-dashed0 dark:checked:border-orange-500 dark:focus:ring-offset-gray-800" id="hs-as-filters-dropdown-all" checked>
          ...
          <thead class="bg-gray-50 dark:bg-orange-800">
              <tr>
      ...
      <div class="p-4 md:p-5 flex gap-x-4">
        ...
        <div class="grow">
          ...
          <div class="mt-1 flex items-center gap-x-2">
            ...
            <span class="inline-flex items-center gap-x-1 py-0.5 px-2 rounded-full bg-orange-100 text-orange-900 bg-orange-800 text-orange-100">
...
<!-- End Card Section -->
      ...
      <div class="flex justify-center p-2 align-middle rounded-lg sm:p-4 bg-orange-100">
	<i class="uil uil-user text-4xl px-1 text-black"></i>
      ...
      <p>
        <div class="text-lg font-extrabold"> Level and Role: </div><div class="text-orange-600 font-extrabold"> Lvl. <?php echo $levels ?> <?php echo $position ?> </div>
        <div class="text-lg font-extrabold">Total Number of Points:</div> <div class="text-orange-600 font-extrabold"> <?php echo $points ?> </div>
        <div class="text-lg font-extrabold">Total Number of Gems: </div><div class="text-orange-600 font-extrabold"> <?php echo $gems ?> </div> 
        ...
        <div class="text-lg font-extrabold">Sports Events Attended:</div><div class="text-orange-600 font-extrabold"><?php echo $sports_count ?></div>
        <div class="text-lg font-extrabold">Extracurricular Events Atended:</div><div class="text-orange-600 font-extrabold"><?php echo $extracurricular_count?> </div> 
      ...
      <div fixed-plugin="">
      <a fixed-plugin-button="" class="bottom-7.5  right-7.5 text-size-xl z-990 shadow-soft-lg rounded-circle fixed cursor-pointer bg-white px-4 py-2 text-orange-700">
