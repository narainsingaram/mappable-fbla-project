...
<!-- Sidebar for Available Spaces -->
<aside class="w-1/4 bg-gray-100 p-4 border-r border-gray-200 h-screen">
  <h3 class="text-lg font-bold mb-4">Travel To A Space</h3>
  <?php
...
<main class='w-3/4 flex flex-col'>
  ...
  <div class="navbar border-t-4 border-amber-400/50">
    ...
    <div class="navbar-end">
      <!-- Additional Navbar options if needed -->
    </div>
  </div>
  ...
  <form method='POST' id='chat_input' class='inline bg-slate-100 flex items-center justify-between w-full p-3' action="space.php?space=<?php echo $space_id; ?>">
