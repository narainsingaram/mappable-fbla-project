...
<form action="comment_frame.php?post_id=<?php echo $post_id; ?>"name="postComment<?php echo $post_id; ?>" method="POST">
    ...
    <div class="flex items-center px-3 py-2 rounded-lg bg-emerald-100 my-4">
        <textarea name="post_body" rows="1" class="block mx-4 p-2.5 w-full text-sm text-gray-900 bg-white rounded-lg border border-gray-300 focus:ring-emerald-500 focus:border-emerald-500" placeholder="Your message..."></textarea>
			<button type="submit" name="postComment<?php echo $post_id; ?>" class="btn inline-flex justify-center p-2 text-emerald-600 rounded-full cursor-pointer hover:bg-emerald-100">
				Comment
			</button>
    </div>
</form>
